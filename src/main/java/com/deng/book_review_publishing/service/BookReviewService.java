...
public interface BookReviewService {
    ...
    public Page<BookReview> findBookReviewByFilters(int pageNum, int pageSize, String sortField, String sortDirection, Long bookId, String reviewAuthor, Long reviewAuthorId, String reviewContent, String reviewTitle, Integer view, byte reviewStatus, byte isDeleted, Integer year, Integer month);
    public Long count();
